...
class Resnet3DBuilder_BERT(object):
    """ResNet3D."""
    
    @staticmethod
    def build(input_shape, num_outputs, block_fn, repetitions, reg_factor,top=True):
        ...
        pool2 = BertModelLayer(num_layers=10)(block)
    ...
    def build_resnet_18(input_shape, num_outputs, reg_factor=1e-4):
        """Build resnet 18."""
        return Resnet3DBuilder_BERT.build(input_shape, num_outputs, basic_block,
    ...
    @staticmethod
    def build_resnet_50(input_shape, num_outputs, reg_factor=1e-4,top=True):
        """Build resnet 50."""
        return Resnet3DBuilder_BERT.build(input_shape, num_outputs, bottleneck,
                                     [3, 4, 6, 3], reg_factor=reg_factor,top=top)
